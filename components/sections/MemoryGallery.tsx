...
export function MemoryGallery() {
  ...
  return (
    <section ref={sectionRef} className="gallery-section w-screen h-screen relative overflow-hidden bg-void">
      ...
      {/* Content Container */}
      {selectedCapsule ? (
        <div className="absolute inset-0 z-20 bg-void/95 backdrop-blur-sm flex flex-col items-center justify-center p-8 overflow-y-auto">
          <motion.div
